...
public class App13 {
    public static void main(String[] args) {
        ...
        int product = compound * years;
        double rate2 = rate / 100;
        double quotient = rate2 / compound;
        double sum = 1 + quotient;
        double compundInterest = principal * (Math.pow(sum,product));
        System.out.printf("$%d invested at %.1f%% for %d years compounded %d times per year is $%.2f. ", principal, rate, years, compound, compundInterest);
    }
}
